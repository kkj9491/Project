				...
				<div class="panel panel-default col-lg-6">
					<div class="panel-body">					
						...
						<div class="row form-group">
							...
							<div class="col-lg-9 checkbox-inline">
								<label><input name="bgreadonly" id="bgreadonly" type="radio" checked="checked" value="Y"><s:message code="board.usedY"/></label>
								<label><input name="bgreadonly" id="bgreadonly" type="radio" value="N"><s:message code="board.usedN"/></label>
							</div>
						</div>
