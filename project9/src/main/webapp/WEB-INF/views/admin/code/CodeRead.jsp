				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-lg-1"><c:out value="${codeInfo.codenm}"/></div>
						</div>					
					</div>				
				</div>
				
				<button class="btn btn-outline btn-primary" onclick="fn_moveToURL('adCodeList')"><s:message code="common.btnList"/></button>
				<button class="btn btn-outline btn-primary" onclick="fn_moveToURL('adCodeDelete?classno=<c:out value="${codeInfo.classno}"/>&codecd=<c:out value="${codeInfo.codecd}"/>, '<s:message code="common.btnDelte"/>')"><s:message code="common.btnDelete"/></button>
