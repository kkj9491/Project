...
function set_Users(usernos, usernms){
	...
	for(var i in nos){
		$("#selectedUsers > tbody").append("<tr id='tr" + nos[i] +"'><td>" + nms[i] + "</td><td><a href='javascript:fn_UserDelete(" + nos[i] +")'><i class='fa fa-times fa-fw'></i></a></td><tr>");
	}	
}
...
function fn_addUser(userno, usernm, deptnm){
	...
	$("#selectedUsers > tbody").append("<tr id='tr" + userno + "'><td>" + usernm + "</td><td><a href='javascript:fn_UserDelete(" + userno + ")'><i class='fa fa-times fa-fw'></i></a></td><tr>");
}
...
function fn_closeUsers(){
	var usernos="", usernms="";
	$("#selectedUsers > tbody > tr").each(function(){
		if(!this.id) return;
					...
					<div class="col-lg-4">
						<div class="panel panel-default">
							...
							<div class="panel-body maxHeight400">
								<table id="selectedUsers" class="table table-striped table-bordered table-hover">
									<colgroup>
										<col width='80%' />
										<col width='10%' />
									</colgroup>
