		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div id="boardlistDiv" style="width:250px; height:300px; display:none;" class="popover fade botton in" role="tooltip">
				...
				<div class="panel-body">
					...
					<c:forEach var="listview" items="${noticelist}" varStatus="status">
						...
						<jsp:include page="BoardListSub.jsp">
							<jsp:param value="${listitemNo}" name="listitemNo"/>
							<jsp:param value="${listitem}" name="listitem"/>
						</jsp:include>					
					</c:forEach>
