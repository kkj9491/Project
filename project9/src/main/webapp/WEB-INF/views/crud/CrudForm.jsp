...
function fn_formSubmit(){
	...
	if (!chkInputValue("#crmemo", '<s:message code="crd.crmemo"/>')) return false;
						...
						<div class="panel-body">
							<div class="row form-group">
								...
								<div class="col-lg-8">
									...
									value="<c:out value="${crdInfo.crtitle}"/>">
								</div>
							</div>
							<div class="row form-group">
								<label class="col-lg-2"><s:message code="crud.crmemo"/></label>
								<div class="col-lg-8">
									<textarea class="form-control" id="crmemo" name="crmemo"><c:out value="${crdInfo.crmemo}"/></textarea>
								</div>
							</div>																				
						</div>
					</div>
