	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="row">
				...
				<button class="btn btn-outline btn-primary" onclick="fn_moveToURL('crudDelete?crno=<c:out value="${crudInfo.crno}"/>', '<s:message code="common.btnDelte"/>')"><s:message code="common.btnDelete"/></button>
