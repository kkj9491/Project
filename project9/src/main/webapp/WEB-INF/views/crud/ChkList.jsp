...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					<button type="button" class="btn btn-default pull-right" onclick="form1.submit()">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="listHead">
						...
						<div class="listHiddenField pull-right field100"><s:message code="crd.usernm"/></div>
					...
					<c:forEach var="listview" items="${listview}" varStatus="status">
						...
						<div class="listBody">
							<div class="listHiddenField pull-left field60 textCenter"><c:out value="${searchVO.totRow-((searchVO.page-1)*searchVO.dispalyRowCount+ status.index)}"/></div>
					...
					<form role="form" id="form1" name="form1" method="post">
						...
						<div class="form-group">
							...
							<div class="input-group custom-search-from col-lg-3">
